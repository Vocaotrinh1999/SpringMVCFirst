			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-6 col-sm-6 col-6 col-lg-2">
						<div class="logo">
							<a href="index.html">
							 	<img alt="logo images"  src="<c:url value="/resources/images/logo/logo.png" />" />
							</a>
						</div>
					</div>
					<div class="col-lg-8 d-none d-lg-block">
						<nav class="mainmenu__nav">
							<ul class="meninmenu d-flex justify-content-start">
								<li class="drop with--one--item"><a href="index.html"><spring:message code="lb.home" text="default text" /></a></li>
								<li class="drop"><a href="#"><spring:message code="lb.shop" text="default text" /></a>
								...
								<li class="drop"><a href="#"><spring:message code="lb.pages" text="default text" /></a>
								...
								<li><a href="contact.html"><spring:message code="lb.contact" text="default text" /></a></li>
							</ul>
						</nav>
					</div>
					<div class="col-md-6 col-sm-6 col-6 col-lg-2">
											...
											<div class="switcher-options">
												<div class="switcher-currency-trigger">
													...
													<ul class="switcher-dropdown">
														...
														<li><a href="?language=vi_VN">Viet Nam</a></li>
														<li>English04</li>
														<li>English05</li>
													</ul>
												</div>
			...
			<div class="container">
				...
				<div class="furniture--4 border--round arrows_style owl-carousel owl-theme row mt--50">
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.html"><img alt="product image"  src="<c:url value="/resources/images/books/1.jpg" />" /></a>
								<a class="second__img animation1" href="single-product.html"><img src="<c:url value="/resources/images/books/2.jpg" />" alt="product image"></a>
								<div class="hot__box">
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.html"><img src="<c:url value="/resources/images/books/3.jpg" />" alt="product image"></a>
								<a class="second__img animation1" href="single-product.html"><img src="<c:url value="/resources/images/books/4.jpg" />" alt="product image"></a>
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.html"><img src="<c:url value="/resources/images/books/5.jpg" />" alt="product image"></a>
								<a class="second__img animation1" href="single-product.html"><img src="<c:url value="/resources/images/books/6.jpg" />" alt="product image"></a>
								<div class="hot__box">
									<span class="hot-label">BEST SALLER</span>
								</div>
							</div>
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.html"><img src="<c:url value="/resources/images/books/7.jpg" />" alt="product image"></a>
								<a class="second__img animation1" href="single-product.html"><img src="<c:url value="/resources/images/books/8.jpg" />" alt="product image"></a>
								<div class="hot__box">
									<span class="hot-label">HOT</span>
								</div>
							</div>
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.html"><img src="<c:url value="/resources/images/books/9.jpg" />" alt="product image"></a>
								<a class="second__img animation1" href="single-product.html"><img src="<c:url value="/resources/images/books/10.jpg" />" alt="product image"></a>
								<div class="hot__box">
									<span class="hot-label">HOT</span>
								</div>
							</div>
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
								<a class="first__img" href="single-product.html"><img src="<c:url value="/resources/images/books/1.jpg" />" alt="product image"></a>
								<a class="second__img animation1" href="single-product.html"><img src="<c:url value="/resources/images/books/12.jpg" />" alt="product image"></a>
								<div class="hot__box">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="footer__widget footer__menu">
								<div class="ft__logo">
									<a href="index.html">
									<img alt="logo"  src="<c:url value="/resources/images/logo/3.png" />" />
									</a>
					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="payment text-right">
								<img alt=""  src="<c:url value="/resources/images/icons/payment.png" />" />
							</div>
						</div>
					</div>
				</div>
